...
interface Source {
    ...
    final class OfReader implements Source, Appendable {
        ...
        static final String LOGGER_NAME = "com.github.robtimus.obfuscation.yaml"; //$NON-NLS-1$

        static final String PREFERRED_MAX_BUFFER_SIZE_PROPERTY = "com.github.robtimus.obfuscation.yaml.preferredMaxBufferSize"; //$NON-NLS-1$
